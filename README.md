...
| # | Training Module | Lab |
|:-:|:-|:-:|
| 01 | Introduction to ZYNQ and PYNQ | N/A |
| 02 | Exploring the PYNQ-Z2 Board | N/A |
| 03 | Getting Started with PYNQ-Z2 Board | lab |
| 04 | Introduction to Jupyter Notebook | demo |
| 05 | Jupyter Notebook Examples | lab |
| 06 | Vitis Application Acceleration Development Flow | N/A |
| 07 | Introduction to PYNQ Overlay Methodology | N/A |
| 08 | PYNQ HLS Design Flow - FIR Filter | demo |
| 09 | PYNQ Overlay Design Flow - FIR Filter | demo |


---
## PYNQ Workshop for v2.6

* Github: PYNQ Workshop for v2.6
